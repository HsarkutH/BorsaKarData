...
public class write {
    ...
    public static void write(){
        ...
        if(!file.exists()) {
            try(Workbook newExcel = new XSSFWorkbook()){
                //Sheet firstSheet = newExcel.createSheet("Kar_Data");
                //Sheet secondSheet = newExcel.createSheet("Kar_Kayıt");
        ...
        try (FileInputStream fileInputStream = new FileInputStream(filePath+fileName)) {
            try(Workbook workbook = new XSSFWorkbook(fileInputStream)) {
                ...
                if (page == null) {
                    page = workbook.createSheet("Kar_Data");
                }
